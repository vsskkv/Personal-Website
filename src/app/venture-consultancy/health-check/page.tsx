...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://vikramsinghkainth.com/venture-consultancy/health-check/',
  },
  openGraph: {
    title: 'Free Power Platform & Microsoft 365 Health Check',
    description: 'Book a free 15-minute Power Platform and M365 audit. Discover how Power Automate and Power Apps can save your UK business time and money.',
    url: 'https://vikramsinghkainth.com/venture-consultancy/health-check/',
    type: 'website',
  },
};
